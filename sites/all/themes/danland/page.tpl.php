...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-23799311-1']);
...
<?php if ($page['slider']): ?>
	...
	</div><!-- /slider region for my personal slideshow-->
<?php endif; ?>

 <?php if($page['preface_first'] || $page['preface_middle'] || $page['preface_last'] || $page['preface_fourth'] || $page['preface_fifth'] || $page['preface_sixth']) : ?>
    <div style="clear:both"></div>
    <div id="preface-wrapper" class="in<?php print (bool) $page['preface_first'] + (bool) $page['preface_middle'] + (bool) $page['preface_last'] + (bool) $page['preface_fourth'] + (bool) $page['preface_fifth'] + (bool) $page['preface_sixth'] ; ?>">
          ...
          <?php endif; ?>
          <?php if($page['preface_fifth']) : ?>
          <div class="column E">
            <?php print render ($page['preface_fifth']); ?>
          </div>
          <?php endif; ?>
          <?php if($page['preface_sixth']) : ?>
          <div class="column F">
            <?php print render ($page['preface_sixth']); ?>
          </div>
          <?php endif; ?>
      <div style="clear:both"></div>
    </div>
...
<div style="clear:both"></div>
<div id="notice"><p about=""
     resource="http://www.w3.org/TR/rdfa-syntax"
     rel="dc:conformsTo" xmlns:dc="http://purl.org/dc/terms/">
    <a href="http://validator.w3.org/check?uri=referer"><img
        src="http://www.w3.org/Icons/valid-xhtml-rdfa"
        alt="Valid XHTML + RDFa" height="25" width="100" /></a>
  </p>
</div> 
